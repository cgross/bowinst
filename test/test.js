...
describe('Bowinst',function(){
    ...
    before(function(){
        ...
        var sampleBowerjson = fs.readFileSync('samplev1_bower.json',{encoding:'utf8'});
        fs.writeFileSync('bower_components/sample/bower.json',sampleBowerjson,{encoding:'utf8'});  

        var updateHtml = fs.readFileSync('_update.html',{encoding:'utf8'});
        fs.writeFileSync('update.html',updateHtml,{encoding:'utf8'});             
    ...
    it('should update (preinstall then install) correctly.',function(done){
        ...
        var bowinstjs = fs.readFileSync('_.bowinst_update.js',{encoding:'utf8'});
